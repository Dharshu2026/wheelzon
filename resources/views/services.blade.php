...
<link
  ...
  integrity="sha512-3hUj2m5XrQumzHZEGQ8tQayDTqZCakHkMWoLMgU2lfY3BBr9XmjEcn5FK1+mx+2JQ/jX6Bw1IlnMJtqHzyC3KQ=="
  ...
  <div class="container">
    <div class="row justify-content-center mb-5">
      <div class="col-md-7 text-center heading-section ftco-animate">
        ...
        <p>Experience smooth rides, trusted service, and affordable prices with <strong>Bike Rental System</strong>.</p>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="services services-2 w-100 text-center">
          <div class="icon d-flex align-items-center justify-content-center" style="color:#fff; font-size:40px;">
            <i class="fa-solid fa-champagne-glasses"></i>
          </div>
          <div class="text w-100">
            <h3 class="heading mb-2">Wedding Rides</h3>
            <p>Make your special day more memorable with our premium bikes for the grand entry!</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3">
        <div class="services services-2 w-100 text-center">
          ...
          <div class="text w-100">
            ...
            <p>Ride across the city comfortably and reach your destination faster with ease.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3">
        <div class="services services-2 w-100 text-center">
          ...
          <div class="text w-100">
            ...
            <p>Need to catch a flight? Rent a bike for quick, on-time rides to the airport.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3">
        <div class="services services-2 w-100 text-center">
          ...
          <div class="text w-100">
            ...
            <p>Explore every corner of the city — adventure starts with our Bike Rental System.</p>
          </div>
        </div>
      </div>
    </div>
